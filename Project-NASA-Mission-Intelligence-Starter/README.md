...
> **Note:** `/opt/venv/lib/python3.10/site-packages/...` is the path used inside the **Udacity workspace/container** environment (Python 3.10). If you're running this locally with your own virtual environment, replace it with your venv's path instead, e.g.:
> ```text
> <your-project-dir>/.venv/lib/python3.9/site-packages/ragas/llms/base.py
> ```
> (Run `python3 -c "import ragas, os; print(os.path.dirname(ragas.__file__))"` inside your venv to find the exact path if your Python version differs.)
